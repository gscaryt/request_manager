...
const letterSectionOpen = new Map();  // sectionId -> explicit open state, overrides the needs-entry auto-open default
...
function isLetterSectionOpen(sectionId, items) {
...
function updateFoot() {
  ...
  el.footInfo.textContent =
    (n ? `${preN} preselected, ${n - preN} manually added` : "") +
